<template>
  <view>
    ...
    <view class="label-container">
      <view class="label-item" v-for="(label, index) in labels" :key="index" :class="{active: label.active}" @click="toggleLabelActive(label)">{{label.name}}</view>
    </view>
